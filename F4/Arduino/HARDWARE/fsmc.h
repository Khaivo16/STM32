...
typedef struct fsmc_reg_map {
    __IO uint32_t BCR1; /**< SRAM/NOR-Flash chip-select control register 1 */
    __IO uint32_t BTR1; /**< SRAM/NOR-Flash chip-select timing register 1 */
    __IO uint32_t BCR2; /**< SRAM/NOR-Flash chip-select control register 2 */
    __IO uint32_t BTR2; /**< SRAM/NOR-Flash chip-select timing register 2 */
    __IO uint32_t BCR3; /**< SRAM/NOR-Flash chip-select control register 3 */
    __IO uint32_t BTR3; /**< SRAM/NOR-Flash chip-select timing register 3 */
    __IO uint32_t BCR4; /**< SRAM/NOR-Flash chip-select control register 4 */
    __IO uint32_t BTR4; /**< SRAM/NOR-Flash chip-select timing register 4 */
    const uint32_t RESERVED1[16];  /**< Reserved */
    __IO uint32_t PCR2;  /**< PC Card/NAND Flash control register 2 */
    __IO uint32_t SR2;   /**< FIFO status and interrupt register 2 */
    __IO uint32_t PMEM2; /**< Common memory space timing register 2 */
    __IO uint32_t PATT2; /**< Attribute memory space timing register 2 */
    const uint32_t RESERVED2;   /**< Reserved */
    __IO uint32_t ECCR2; /**< ECC result register 2 */
    const uint32_t RESERVED3[2];   /**< Reserved */
    __IO uint32_t PCR3;  /**< PC Card/NAND Flash control register 3 */
    __IO uint32_t SR3;   /**< FIFO status and interrupt register 3 */
    __IO uint32_t PMEM3; /**< Common memory space timing register 3 */
    __IO uint32_t PATT3; /**< Attribute memory space timing register 3 */
    const uint32_t RESERVED4;     /**< Reserved */
    __IO uint32_t ECCR3; /**< ECC result register 3 */
    const uint32_t RESERVED5[2];   /**< Reserved */
    __IO uint32_t PCR4;  /**< PC Card/NAND Flash control register 4 */
    __IO uint32_t SR4;   /**< FIFO status and interrupt register 4 */
    __IO uint32_t PMEM4; /**< Common memory space timing register 4 */
    __IO uint32_t PATT4; /**< Attribute memory space timing register 4 */
    __IO uint32_t PIO4;  /**< I/O space timing register 4 */
    const uint32_t RESERVED6[20];  /**< Reserved */
    __IO uint32_t BWTR1; /**< SRAM/NOR-Flash write timing register 1 */
    const uint32_t RESERVED7;     /**< Reserved */
    __IO uint32_t BWTR2; /**< SRAM/NOR-Flash write timing register 2 */
    const uint32_t RESERVED8;     /**< Reserved */
    __IO uint32_t BWTR3; /**< SRAM/NOR-Flash write timing register 3 */
    const uint32_t RESERVED9;     /**< Reserved */
    __IO uint32_t BWTR4; /**< SRAM/NOR-Flash write timing register 4 */
...
typedef struct fsmc_nor_psram_reg_map {
    __IO uint32_t BCR;            /**< Chip-select control register */
    __IO uint32_t BTR;            /**< Chip-select timing register */
    const uint32_t RESERVED[63];  /**< Reserved */
    __IO uint32_t BWTR;           /**< Write timing register */
