 ...
 */
extern uint8_t I2C_ReadMulti(I2C_TypeDef* I2Cx, uint8_t address, uint8_t reg, uint8_t *data, uint16_t count);
 ...
 */
extern uint8_t I2C_WriteMulti(I2C_TypeDef* I2Cx, uint8_t address, uint16_t reg, uint8_t *data, uint16_t count);
