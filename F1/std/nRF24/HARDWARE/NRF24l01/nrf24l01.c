...
//	
//	GPIO_SETUP(NRF24L01_CSN_PORT,NRF24L01_CSN_PIN,GPIO_Mode_Out_PP,GPIO_Speed_50MHz);
//	GPIO_SETUP(NRF24L01_CE_PORT,NRF24L01_CE_PIN,GPIO_Mode_Out_PP,GPIO_Speed_50MHz);
//	NRF24L01_CE_HIGH;
//	NRF24L01_CSN_HIGH;
//}
...
//	NRF24L01_InitPins();
	//Initialize SPI
//	SPIx_Init(NRF24L01_SPI, NRF24L01_SPI_PINS);
	SPI_init(NRF24L01_SPI,SPI_Mode_Master,SPI_BaudRatePrescaler_256);
	...
	NRF24L01_Struct.OutPwr = NRF24L01_OutputPower_M12dBm;
