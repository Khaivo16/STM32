 ...
 * 	Returns 1
 */
extern uint8_t NRF24L01_Init(uint8_t channel, uint8_t payload_size);
 ...
 */
extern void NRF24L01_SetMyAddress(uint8_t* adr);

extern void NRF24L01_SetPipe2Address(uint8_t adr);
extern void NRF24L01_SetPipe3Address(uint8_t adr);
extern void NRF24L01_SetPipe4Address(uint8_t adr);
extern void NRF24L01_SetPipe5Address(uint8_t adr);
 ...
 * 	- uint8_t* adr: pointer to 5 bytes of address
 */
extern void NRF24L01_SetTxAddress(uint8_t* adr);
 ...
 */
extern uint8_t NRF24L01_GetRetransmissionsCount(void);
 ...
 *
 */
extern void NRF24L01_PowerUpTx(void);
 ...
 *
 */
extern void NRF24L01_PowerUpRx(void);
 ...
 */
extern void NRF24L01_PowerDown(void);
 ...
 */
extern NRF24L01_Transmit_Status_t NRF24L01_GetTransmissionStatus(void);
 ...
 */
extern void NRF24L01_Transmit(uint8_t *data);
 ...
 */
extern void NRF24L01_GetData(uint8_t *data);
 ...
 */
extern uint8_t NRF24L01_DataReady(void);
 ...
 */
extern void NRF24L01_SetChannel(uint8_t channel);
 ...
 */
extern void NRF24L01_SetRF(NRF24L01_DataRate_t DataRate, NRF24L01_OutputPower_t OutPwr);

/**
 * Private functions
 */
extern uint8_t NRF24L01_GetStatus(void);
extern void NRF24L01_InitPins(void);
extern void NRF24L01_WriteBit(uint8_t reg, uint8_t bit, BitAction value);
extern uint8_t NRF24L01_ReadBit(uint8_t reg, uint8_t bit);
extern uint8_t NRF24L01_ReadRegister(uint8_t reg);
extern void NRF24L01_ReadRegisterMulti(uint8_t reg, uint8_t* data, uint8_t count);
extern void NRF24L01_WriteRegister(uint8_t reg, uint8_t value);
extern void NRF24L01_WriteRegisterMulti(uint8_t reg, uint8_t *data, uint8_t count);
extern void NRF24L01_SoftwareReset(void);
extern uint8_t NRF24L01_RxFifoEmpty(void);
