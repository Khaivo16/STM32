...
uint16_t adcRead(uint32_t ulPin, uint8_t Resolution);
uint16_t analogRead(uint32_t ulPin);

void analogWrite(uint32_t ulPin, uint32_t ulValue);
void dacWrite(uint8_t pin, uint32_t value);
void dacStop(uint8_t pin);
//void pwmStart(uint8_t pin, uint32_t PWM_freq, uint32_t value, TimerCompareFormat_t resolution);
//void pwmStop(uint8_t pin);	//#include "HardwareTimer.h"
