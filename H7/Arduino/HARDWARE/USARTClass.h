...
class USARTClass : public Stream
{
  ...
  protected:
    ...
    uint32_t _dwId ;
		...
		DMA_TypeDef  *dmaU1,*dmaU2,*dmaU3,*dmaU4,*dmaU5,*dmaU6,*dmaU7; 
	
		DMA_Stream_TypeDef *streamU1_Tx,*streamU2_Tx,*streamU3_Tx,*streamU4_Tx,*streamU5_Tx,*streamU6_Tx,*streamU7_Tx;
		DMA_Stream_TypeDef *streamU1_Rx,*streamU2_Rx,*streamU3_Rx,*streamU4_Rx,*streamU5_Rx,*streamU6_Rx,*streamU7_Rx;
		uint8_t pTx;
		uint8_t pRx;
  ...
  public:
    ...
    size_t write( const uint8_t c ) ;
		...
		void DMA_Init(DMA_TypeDef  *dev, DMA_Stream_TypeDef *streamTx, DMA_Stream_TypeDef *streamRx);
