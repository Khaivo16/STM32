...
{
	{ NULL, NULL,NULL, NULL, NULL, NULL}, // 00
  { GPIOA, GPIO_PIN_0,RCC_CLK_GPIOA, ADC_CHANNEL_16, TIM2, TIM_CHANNEL_1}, // 0     // TIM2+TIM5 =TIM_CHANNEL_1    
  { GPIOA, GPIO_PIN_1,RCC_CLK_GPIOA, ADC_CHANNEL_17, TIM2, TIM_CHANNEL_2}, // 1         // TIM2+TIM5 =TIM_CHANNEL_2 
  { GPIOA, GPIO_PIN_2,RCC_CLK_GPIOA, ADC_CHANNEL_14, TIM2, TIM_CHANNEL_3}, // 2				//TIM2_CH3, TIM5_CH3,
	{ GPIOA, GPIO_PIN_3,RCC_CLK_GPIOA, ADC_CHANNEL_3, TIM2, TIM_CHANNEL_4}, // 3     //      
  { GPIOA, GPIO_PIN_4,RCC_CLK_GPIOA, ADC_CHANNEL_18, NULL, NULL}, // 4         // 
  { GPIOA, GPIO_PIN_5,RCC_CLK_GPIOA, ADC_CHANNEL_19, TIM2, TIM_CHANNEL_1}, // 5
	{ GPIOA, GPIO_PIN_6,RCC_CLK_GPIOA, ADC_CHANNEL_3, TIM3, TIM_CHANNEL_1}, // 6     //      
